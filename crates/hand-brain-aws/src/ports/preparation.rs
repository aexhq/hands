...
impl AwsHand {
    async fn purge_one_target(
        &self,
        record: &hand_core::materialization::DurableTargetRecord,
    ) -> HandResult<PurgeStep> {
    ...
    async fn recover_materializing(
        ...
        let installed = match self
            ...
            .map_err(materialization_error)?
        {
            hand_core::materialization::InstallOutcome::Installed(installed) => installed,
